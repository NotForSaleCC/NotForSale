defmodule NotforsaleWeb.Router do
  use NotforsaleWeb, :router

  import NotforsaleWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {NotforsaleWeb.LayoutView, :root}
...
[]
  ...
  scope "/api/v1", NotforsaleWeb.Api.V1, as: :api_v1 do
    ...
    post "/frames/print", FrameController, :print
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: NotforsaleWeb.Telemetry
    end
  end
